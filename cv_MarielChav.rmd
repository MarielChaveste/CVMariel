...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1uLqol-4jRJD5a8a65wdQj8ibh2kc2tcVt4wbdAJmaNo/edit?gid=917338460#gid=917338460",  
  pdf_mode = params$pdf_mode
 )
...
Bioinformatic Skills {#skills}
--------------------------------------------------------------------------------

```{r}
CV %>% print_bioinformatic_habilities()
```
...
The source code is available at [MarielChaveste/CVMariel](https://github.com/MarielChaveste/CVMariel) and is powered by [nstrayer/cv](https://github.com/nstrayer/cv).
...
Mariel Guadalupe Gutiérrez Chaveste {#title}
--------------------------------------------------------------------------------
...
Conference Participation {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------
